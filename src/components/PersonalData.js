                ...
                <form>
                    <fieldset>
                        ...
                        <div id="part-1">
                            ...
                            <input type="text" name="last-name1" id="last-name1" required></input>
                            <br></br>
                            <label for="last-name2">Segundo Apellido</label>
                            <input type="text" name="last-name2" id="last-name2" required></input>
                            <br></br>
                            ...
                            <select name="provinciaSelect" required>
