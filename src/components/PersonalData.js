...
export default class PersonalData extends Component {
    render() {
        return (     
            <div id="container">
                ...
                <br></br>
                    <div id="part-1">
                            ...
                            <input type="date" name="birthdate" min="1917-01-01" id="birthdate" required></input>
                            <br></br>
                            <label for="age">Cédula de identificación</label>
                            <input type="number" name="age" min="0" max="100" id="age" required></input>
                            <br></br>
                            <label for="civilState">Estado civil</label> <br></br>
                            <select name="civilState" id="civilSt" required>
                            ...
                            <br></br>
                            <br/><br/>
            <label for="country">Seleccione su país de nacimiento</label>
            <br/>
            <select name="country" id="country" required>
                <option id = "select-cs" value="" label="Seleccione el país" selected="selected">Select a country …       </option>
            ...
            <select name="provinciaSelect" id="provincia" required>
            ...
            <br></br><br></br>
            <select name="cantonSelect" id="canton" required>
            ...
            <br></br><br></br>
            <select name="distritoSelect" id="distrito" required>
            ...
            <input type="text" name="address" id="fulladdress" required></input>
            <br></br>
